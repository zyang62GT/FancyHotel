...
session_start();
  ...
  $month = $_GET['month'];
  $reservation_result = mysql_query("SELECT MONTH(StartDate), RoomLoc, SUM(TotalCost)
        FROM Reservation
        INNER JOIN HasRoom
        ...
        AND RoomLoc =  'Atlanta';");
$reservation_result2 = mysql_query("SELECT MONTH(StartDate),RoomLoc, SUM(TotalCost)
        FROM Reservation
        INNER JOIN HasRoom
        INNER JOIN Room ON ReservationID = ReserveID
        AND (
...
$reservation_result3 = mysql_query("SELECT MONTH(StartDate), RoomLoc, SUM(TotalCost)
        FROM Reservation
        INNER JOIN HasRoom
        INNER JOIN Room ON ReservationID = ReserveID
        AND (
...
$reservation_result4 = mysql_query("SELECT MONTH(StartDate), RoomLoc, SUM(TotalCost)
        FROM Reservation
        INNER JOIN HasRoom
        INNER JOIN Room ON ReservationID = ReserveID
        AND (
        ...
        WHERE MONTH( StartDate ) =  '1'
        AND RoomLoc =  'Orlando';");
$reservation_result5 = mysql_query("SELECT MONTH(StartDate), RoomLoc, SUM(TotalCost)
        FROM Reservation
        INNER JOIN HasRoom
        INNER JOIN Room ON ReservationID = ReserveID
        AND (
